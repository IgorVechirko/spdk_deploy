...
sudo ./scripts/rpc.py bdev_ha_create_header /root/wc/ha/ha_header.json --device_id 1 --device_nqn nqn.2016-06.sw.ha:ha1 --uuid 6d28acdf-7d3e-49b2-ac07-f5678160d7c3 --device_size 1GiB --local_node_id 2 --local_node_type SYNC_REPLICA --ha_creation_action create_new --local_node_data_replica ram_bdev
