...
sudo ./scripts/rpc.py bdev_ha_create_header /root/wc/ha/ha_header.json --device_id 1 --device_nqn nqn.2016-06.sw.ha:ha0 --device_size 1GiB --uuid 6d28acdf-7d3e-49b2-ac07-f5678160d7c3 --ha_creation_action create_new --local_node_id 1 --local_node_nsid 1 --local_node_data_replica ram_bdev --node_partners_channel "SYNC TCP 30.30.30.101 8523" --node_partners_channel "HEARTBEAT TCP 20.20.20.101 6547"
sudo ./scripts/rpc.py bdev_ha_create Ha0 /root/wc/ha/ha_header.json

sudo ./scripts/rpc.py bdev_ha_append_node Ha0 --node_id 2 --node-nsid 1 --partners_channel "SYNC TCP 30.30.30.102 9735" --partners_channel "HEARTBEAT TCP 20.20.20.102 1374"
...
sudo ./scripts/rpc.py nvmf_subsystem_add_listener nqn.2016-06.sw.ha:ha0 -t tcp -a "40.40.40.101" -s 4420