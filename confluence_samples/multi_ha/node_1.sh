...
sudo ./scripts/rpc.py bdev_ha_create_header /root/wc/ha/ha2_header.json --device_id 2 --device_nqn nqn.2016-06.sw.ha2:node --device_size 512MB --uuid 6d28acdf-0000-49b2-ac07-f5678160d7c4 --ha_creation_action create_new --local_node_id 1 --local_node_type SYNC_REPLICA --local_node_nsid 1 --local_node_data_replica ha2_1_node --node_partners_channel "SYNC TCP 10.10.10.2 7544" --node_partners_channel "HEARTBEAT TCP 10.10.10.2 7403"

sudo ./scripts/rpc.py bdev_ha_create Ha2 /root/wc/ha/ha2_header.json

sudo ./scripts/rpc.py bdev_ha_add_remote_node Ha2 --remote_node_id 2 --remote_node_type SYNC_REPLICA --partners_channel "SYNC TCP 10.10.10.3 7654" --partners_channel "HEARTBEAT TCP 10.10.10.3 7654"
