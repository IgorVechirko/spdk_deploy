...
sudo ./scripts/rpc.py bdev_ha_create_header /root/wc/ha/ha1_header.json --device_id 1 --local_node_id 2 --local_node_type SYNC_REPLICA --local_node_nqn nqn.2016-06.sw.ha1:node --local_node_data_replica ha1_2_node --ha_creation_action create_new

sudo ./scripts/rpc.py bdev_ha_create Ha1 /root/wc/ha/ha1_header.json

sudo ./scripts/rpc.py bdev_ha_add_remote_node Ha1 --remote_node_id 1 --remote_node_type SYNC_REPLICA --remote_node_nqn nqn.2016-06.sw.ha1:node --remote_node_channel "tcp 192.168.0.102 4421"
...
sudo ./scripts/rpc.py bdev_ha_create_header /root/wc/ha/ha2_header.json --device_id 2 --local_node_id 2 --local_node_type SYNC_REPLICA --local_node_nqn nqn.2016-06.sw.ha2:node --local_node_data_replica ha2_2_node --ha_creation_action create_new

sudo ./scripts/rpc.py bdev_ha_create Ha2 /root/wc/ha/ha2_header.json

sudo ./scripts/rpc.py bdev_ha_add_remote_node Ha2 --remote_node_id 1 --remote_node_type SYNC_REPLICA --remote_node_nqn nqn.2016-06.sw.ha2:node --remote_node_channel "tcp 192.168.0.102 4421"
